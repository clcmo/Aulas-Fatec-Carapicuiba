<?php 
	...
	echo'<h2>'.$textConsulta.' de '. $consultas.'</h2>
		<table id="customers">
		<tr>
			<th>Codigo</th>
			<th>Paciente</th>
		...
		<tr>';
		$sql = "SELECT * FROM ag_consulta, paciente, medico where (ag_consulta.id_pac = paciente.id_pac && ag_consulta.id_med = medico.id_med)";
