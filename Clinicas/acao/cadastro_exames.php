<?php
	...
	if($retornou == false){
		$sql = "INSERT INTO `ag_exame`(`id_pac`, `id_med`, `data_con`, `data_ag`) VALUES (:id_pac, :id_med, :data_con, :data_ag)";
			...
			//	return ("../cadastro_pacientes.php");
				echo "<br> Exame já cadastrado </br>";
			}
			//return ("../cadastro_pacientes.php");
			echo "<br> Exame registrado com sucesso </br>";
	}
?>